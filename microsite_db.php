...
<div class="container">  	
	<div class="row">
		...
		<div class="col-85">
			<h2>Select Microsite</h2>
			<div class="row">
				<div class="col-25">
					<form method="POST" action="process/selectmicrosite.php">
						<select name="microsite_db" required onchange="this.form.submit();">
							<?php echo getMicrosite(); ?>
						</select>
					</form>
				</div>
			</div>
