...
$user = $_SESSION['username'];
	...
	if(isset($_POST['submit'])){
	  ...
	  $prev_value = 	$_POST['prev_value'];
		...
		$current_value = "Page Affected: ".$page_name;    	
  	updatePage($page_name,$id);
...
<div class="container">  	
	<div class="row">
		...
		<div class="col-85">
			<div class="content">
				<h2>Edit Landing Page name</h2>
				<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					<input type="hidden" name="id" value="<?php echo $id;?>">
					<div class="row">
						<div class="col-25">
							<label for="bname">Landing Page</label>
						</div>
					</div>
					<div class="row">
						<div class="col-50">
							<input type="text" name="page_name" required value="<?php echo $page_name; ?>">	
						</div>
					</div>					
					<div class="row">
						<br/><br/>
						<?php 
							$prev_value = "Page Affected: ".$page_name;
						?>
						<input type="hidden" name="prev_value" value="<?php echo $prev_value; ?>">
						<a class="btn-back" href="landing_page.php">BACK</a>
