			...
			<div class="row">
				<div class="col-100">
					...
					<?php if($_SESSION['role_id']==1) { ?>
						<a href="fieldnames_create.php" class="add-btn">CREATE FIELD NAME</a>
					<?php } ?>
					<br/><br/><br/><br/>
					<?php 
					...
					?>
						...
						<td><?php echo $row['microsite_fieldname']; ?></td>
						<td><?php echo $row['createddate']; ?></td>
						<?php if($_SESSION['role_id']==1) { ?>
						<td>
			        		<button><a style='text-decoration:none' href='fieldnames_edit.php?id=<?php echo $row['fieldname_id']; ?>'>edit</a></button>				        	
			        		<a style='text-decoration:none' href='fieldnames_delete.php?id=<?php echo $row['fieldname_id']; ?>' onClick='return confirm('Are you sure you want to delete?')'>delete</a>			        		
			        	</td>
			        	<?php } ?>
					</tr>
					<?php				
