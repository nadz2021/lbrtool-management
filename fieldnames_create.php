<?php
include "fieldnames_create__.php";
?>
<html lang="en">
		...
		<div class="col-85">
			<div class="content">
				...
				<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					...
					<div class="row">
						<div class="col-25">
							<label for="bname">Database Field Name</label>
						</div>
					</div>
					<div class="row">
						<div class="col-25">
					...
					<div class="row">
						<div class="col-25">
							<label for="bname">Microsite Field Name/s</label>
						</div>
					</div>
					<div class="row">
						<div class="col-25">
							<input type="text" name="microsite_fieldname" required>
						</div>
					</div>
					<div class="row">
						<br/><br/>
